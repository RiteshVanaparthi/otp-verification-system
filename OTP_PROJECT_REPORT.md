          ...
          <section class="card-soft p-4 h-100">
            ...
            <form id="generateForm" class="vstack gap-3">
              ...
              <button class="btn btn-brand btn-lg w-100" type="submit">
                <span class="spinner-icon">âš¡</span> Generate OTP
              </button>
            </form>
          </section>
        </div>
          ...
          <section class="card-soft p-4 h-100">
            ...
            <form id="verifyForm" class="vstack gap-3">
              ...
              <button class="btn btn-success btn-lg w-100" type="submit">
                <span class="spinner-icon">âœ“</span> Verify OTP
              </button>
            </form>
          </section>
        </div>
        ...
        <div class="col-12 col-xl-6">
          <section class="card-soft p-4 h-100">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <button id="fetchUsersBtn" class="btn btn-sm btn-outline-brand" type="button">ðŸ“‹ Fetch Users</button>
            </div>
            <p class="small text-secondary mb-3">
              âœ“ Verify OTP first, then create user with the same verified email/phone.
            </p>
            ...
            <form id="createUserForm" class="row g-3">
              ...
              <div class="col-12">
                <button class="btn btn-brand w-100" type="submit">âž• Create User</button>
              </div>
            </form>
          </section>
        </div>
        ...
        <div class="col-12 col-xl-6">
          <section class="card-soft p-4 h-100">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <button id="clearLogsBtn" class="btn btn-sm btn-outline-secondary" type="button">ðŸ—‘ Clear</button>
            </div>
...
### âœ¨ Verification Logs Feature

The frontend now includes a **ðŸ“œ Verification History** section that:
